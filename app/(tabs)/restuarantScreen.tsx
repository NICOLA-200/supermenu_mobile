...
import { dummyRestaurants } from '../../constants/dummyData';
...
const Restoraurant = () => {
  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      ...
      <View className="w-full my-4 mt-6  px-4">
        <TextInput
  ...
  contentContainerStyle={{ paddingBottom: 120 }} // Extra padding to avoid clipping with tab bar
